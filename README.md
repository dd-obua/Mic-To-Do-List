...
**To Do List** system for organizing one's activities for a particular day.
...
- **Display of a list tasks to be completed**
...
```sh
  git clone git@github.com:dd-obua/Mic-To-Do-List.git
```
...
- **Functionality to adding tasks**
- **Functionality for storing tasks in local storage**
...
Feel free to check the [issues page](https://github.com/dd-obua/Mic-To-Do-List/issues).
...
If you like this project, all forms of contribution are welcome.
...
I would like to thank Filbert, Samson and Obote for their encouragement and support.
